...
def main():
    ...
    try:
        ...
        if archivos_nc:
            ...
            print("No se encontraron archivos para combinar o revisa \033[3moption\033[0m, \033[3mformat\033[0m y el apartado #Verificar si hay archivos .nc temporales# del script.")
